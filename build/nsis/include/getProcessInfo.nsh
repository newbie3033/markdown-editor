...
; Both function variants are always defined: the custom-script flow compiles
; the installer and uninstaller sides in a single pass, so the regular and
; "un."-prefixed implementations must both exist.
