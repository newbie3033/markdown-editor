!ifndef nsProcess::FindProcess
    !include "${BUILD_RESOURCES_DIR}/nsis/include/nsProcess.nsh"
!endif

!ifmacrondef customCheckAppRunning
  !include "${BUILD_RESOURCES_DIR}/nsis/include/getProcessInfo.nsh"
  Var pid
!endif
...
!macro CHECK_APP_RUNNING
  # Guard the Var declarations: in the custom-script flow this macro is expanded
  # both on the installer side and the uninstaller side of a single compilation.
  !ifndef __CHECK_APP_RUNNING_VARS_DEFINED
    !define __CHECK_APP_RUNNING_VARS_DEFINED
    Var /GLOBAL CmdPath
...
!macro IS_POWERSHELL_AVAILABLE
  !ifndef __IS_POWERSHELL_AVAILABLE_VARS_DEFINED
    !define __IS_POWERSHELL_AVAILABLE_VARS_DEFINED
